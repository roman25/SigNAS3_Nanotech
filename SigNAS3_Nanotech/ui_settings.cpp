...
{
    /*
        Allows get settings in other window
    */
    return outSettings;
}
...
void SigNAS3_Nanotech::ui_settings::butSet_Click(System::Object^ Sender, System::EventArgs^ Args)
{
    ...
    */
    ...
    // Close window and save settings when Set button clicked
    Close();
    
}

void SigNAS3_Nanotech::ui_settings::InitializeComponent()
{
    /*
        Creates UI elemetns
    */
